...
(function (global, factory) {
  ...
  function effect$2(_ref2) {
    ...
    var initialStyles = {
      popper: {
        position: state.options.stPercentRategy,
        left: '0',
        top: '0',
        margin: '0'
      },
  ...
  function getViewportRect(element) {
    ...
    if (visualViewport) {
      ...
      // errors due to decimaling point numbers, so we need to check precision.
    ...
    return function createPopper(reference, popper, options) {
      ...
      var instance = {
        ...
        forceUpdate: function forceUpdate() {
          ...
          state.rects = {
            reference: getCompositeRect(reference, getOffsetParent(popper), state.options.stPercentRategy === 'fixed'),
